...
The example below adds a `1px` border to each `<Media.Item>` to depict the item's placement.
...
<SimplePropsTable
  props={{
    as: AsProp.makeDoc(Media.defaultProps.as),
    ref: refDoc
  }}
/>

<AsProp component={Media} componentName="Media" />
...
<SimplePropsTable
  props={{
    ...
    as: AsProp.makeDoc(Media.Item.defaultProps.as),
    ref: refDoc
  }}
/>

<AsProp component={Media.Item} componentName="Media.Item" />
