...
import { AsProp, Frame, SimplePropsTable, refDoc } from "src/__docs__";
...
<SimplePropsTable
  props={{
    ...
    as: AsProp.makeDoc(Modal.defaultProps.as),
    closeOnBlur: {
      description:
...
<AsProp component={Modal} componentName="Modal" />

## Modal.Background

<SimplePropsTable
  props={{
    as: AsProp.makeDoc(Modal.Background.defaultProps.as),
    onClick: {
      description: "A callback when the component is clicked",
...
<AsProp component={Modal.Background} componentName="Modal.Background" />

## Modal.Card.Body

<SimplePropsTable
  props={{
    as: AsProp.makeDoc(Modal.Card.Body.defaultProps.as),
    ref: refDoc
  }}
/>

<AsProp component={Modal.Card.Body} componentName="Modal.Card.Body" />

## Modal.Card.Foot

<SimplePropsTable
  props={{
    as: AsProp.makeDoc(Modal.Card.Foot.defaultProps.as),
    ref: refDoc
  }}
/>

<AsProp component={Modal.Card.Foot} componentName="Modal.Card.Foot" />

## Modal.Card.Title

<SimplePropsTable
  props={{
    as: AsProp.makeDoc(Modal.Card.Title.defaultProps.as),
    ref: refDoc
  }}
/>

<AsProp component={Modal.Card.Title} componentName="Modal.Card.Title" />

## Modal.Card

<SimplePropsTable
  props={{
    as: AsProp.makeDoc(Modal.Card.defaultProps.as),
    ref: refDoc
  }}
/>

<AsProp component={Modal.Card} componentName="Modal.Card" />

## Modal.Close

<SimplePropsTable
  props={{
    as: AsProp.makeDoc(Modal.Close.defaultProps.as),
    onClick: {
      description: "A callback when the component is clicked",
      typeName: "(event: React.MouseEvent) => void"
    },
...
<AsProp component={Modal.Close} componentName="Modal.Close" />

## Modal.Content

<SimplePropsTable
  props={{
    as: AsProp.makeDoc(Modal.Content.defaultProps.as),
    ref: refDoc
  }}
/>

<AsProp component={Modal.Content} componentName="Modal.Content" />
