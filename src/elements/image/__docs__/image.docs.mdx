...
<SimplePropsTable
  props={{
    as: AsProp.makeDoc(Image.defaultProps.as),
    ref: refDoc,
    rounded: {
...
<AsProp component={Image} componentName="Image" />

## Image.Container

<SimplePropsTable
  props={{
    as: AsProp.makeDoc(Image.Container.defaultProps.as),
    ref: refDoc,
    size: {
...
<AsProp component={Image.Container} componentName="Image.Container" />
