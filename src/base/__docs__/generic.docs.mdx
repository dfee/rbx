...
This component applies standard _Bulma_ theming to any element or component.
...
<SimplePropsTable
  props={{
    ...
    srOnly: {
      description:
        "hides the element visually but keeps the element available to be announced by a screen reader",
      typeName: "boolean",
    },
  }}
/>
