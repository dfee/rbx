...
<SimplePropsTable
  props={{
    mobile: {
      ...
      typeName: "Limited Responsive Object"
    },
    tablet: {
...
<div className="notification">
  <h4 className="title is-4">Responsive Object & Limited Responsive Object</h4>
  <p>
  ...
  <p>
    <code>textAlignment.value</code> specifies – for a specific breakpoint – the
    alignment of the text, while <code>textAlignment.only</code> specifies if it
  ...
  <p className="has-text-info">
    ...
    <strong>Limited Responsive Object</strong>, is that the latter does not permit
